    ...
    <>
        ...
        {isCard ? (
          ...
          <div
            style={{
              ...
              boxShadow: isLink
                ? '0 0 14px rgba(200,146,42,0.35)'
                : '0 0 8px rgba(200,146,42,0.2)',
              background: isLink ? 'rgba(201,168,76,0.05)' : 'transparent',
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: isCard
            ? '0 0 14px var(--color-accent), 0 0 28px rgba(201,168,76,0.35)'
