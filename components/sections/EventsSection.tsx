          ...
          >
            {emoji === 'diya'
              ? <div style={{ position: 'relative', display: 'inline-flex' }}>
                  ...
                  <img loading="lazy" src="/assets/diya.webp" alt="" className="lantern-glow" style={{ width: 40, height: 'auto', position: 'relative', zIndex: 1 }} />
                </div>
              : emoji}
          </div>
        )}
      ...
      >
        ...
        {event.venueMapLink && (
          <a
            ...
            className="inline-flex items-center gap-1 mt-3 px-4 py-2 rounded-full font-sans text-xs font-semibold whitespace-nowrap transition-all hover:opacity-90"
